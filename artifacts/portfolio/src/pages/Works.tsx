...
const projects = [
  ...
  },
  {
    ...
    title: "River Scene",
    category: "3D Art",
    description: "A misty lakeside environment in Blender — volumetric fog, reflective water, a cabin and boat nestled among trees.",
    tags: ["Blender", "Environment", "Lighting"],
    image: "/images/river-scene.png"
  },
  {
    id: 6,
    title: "Forest Floor",
    category: "3D Art",
    description: "A close-up forest floor study with dense ground cover, scattered leaves and natural lighting.",
    tags: ["Blender", "Environment", "Nature"],
    image: "/images/forest-floor.png"
  },
  {
    id: 3,
    title: "Sociopedia",
