        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <div>
              ...
              <div className="prose prose-invert max-w-none text-muted-foreground text-lg leading-relaxed">
                <p>
                  I&apos;m <strong className="text-foreground">Ishan Ghadiya</strong>, a creative technologist who structures web experiences with production-grade code, then breaks into the third dimension with spatial composition and VFX pipelines.
                </p>
                <p>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 relative z-10">
              ...
              <button
                type="submit"
                className="inline-flex h-11 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-all hover:bg-primary/90 hover:shadow-[0_0_20px_rgba(0,240,255,0.35)] focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
              >
                Send Transmission
              </button>
            </form>
